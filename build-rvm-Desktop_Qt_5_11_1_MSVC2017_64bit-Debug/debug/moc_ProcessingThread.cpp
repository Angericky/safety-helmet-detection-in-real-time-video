...
#include "../../src/main/threads/ProcessingThread.h"
...
void ProcessingThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ProcessingThread::*)(const QImage & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProcessingThread::newFrame)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ProcessingThread::*)(const QImage & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProcessingThread::origFrame)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ProcessingThread::*)(ThreadStatisticsData );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProcessingThread::updateStatisticsInGUI)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProcessingThread::frameWritten)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (ProcessingThread::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProcessingThread::maxLevels)) {
                *result = 4;
                return;
            }
        }
