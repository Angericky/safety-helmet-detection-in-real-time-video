...
#include "../../src/main/threads/CaptureThread.h"
...
QT_MOC_LITERAL(1, 14, 21), // "updateStatisticsInGUI"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 20), // "ThreadStatisticsData"
QT_MOC_LITERAL(4, 58, 15), // "updateFramerate"
QT_MOC_LITERAL(5, 74, 3) // "FPS"

    },
    "CaptureThread\0updateStatisticsInGUI\0"
    "\0ThreadStatisticsData\0updateFramerate\0"
    "FPS"
};
...
void CaptureThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateFramerate((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CaptureThread::*)(ThreadStatisticsData );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CaptureThread::updateStatisticsInGUI)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CaptureThread::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CaptureThread::updateFramerate)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void CaptureThread::updateStatisticsInGUI(ThreadStatisticsData _t1)
{
...
// SIGNAL 1
void CaptureThread::updateFramerate(double _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
