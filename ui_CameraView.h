...
public:
    ...
    {
        CameraView->setWindowTitle(QApplication::translate("CameraView", "Form", Q_NULLPTR));
        recordButton->setText(QApplication::translate("CameraView", "Record", Q_NULLPTR));
        recordOriginalCheckbox->setText(QApplication::translate("CameraView", "Record Original", Q_NULLPTR));
        recordPathButton->setText(QApplication::translate("CameraView", "Select Destination", Q_NULLPTR));
        hideSettingsButton->setText(QApplication::translate("CameraView", "Hide Settings", Q_NULLPTR));
        label_26->setText(QApplication::translate("CameraView", "Camera Resolution:", Q_NULLPTR));
        label_27->setText(QApplication::translate("CameraView", "Capture Rate:", Q_NULLPTR));
        captureRateLabel->setText(QString());
        nFramesCapturedLabel->setText(QString());
        label_23->setText(QApplication::translate("CameraView", "Processing Rate:", Q_NULLPTR));
        processingRateLabel->setText(QString());
        nFramesProcessedLabel->setText(QString());
        label_28->setText(QApplication::translate("CameraView", "ROI:", Q_NULLPTR));
        roiLabel->setText(QString());
        label_22->setText(QApplication::translate("CameraView", "Cursor:", Q_NULLPTR));
        mouseCursorPosLabel->setText(QString());
        label_25->setText(QApplication::translate("CameraView", "Image Buffer:", Q_NULLPTR));
        imageBufferLabel->setText(QString());
        clearImageBufferButton->setText(QApplication::translate("CameraView", "Clear Image Buffer", Q_NULLPTR));
        label_24->setText(QApplication::translate("CameraView", "Camera Device Number:", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(InfoTab), QApplication::translate("CameraView", "Stream Information", Q_NULLPTR));
    } // retranslateUi
